...
Two audiences, two voices. Korean and English for each. Use freely on Gumroad / Etsy / landing pages.
...
**Tagline:** *Know what your coffee habit really costs — and how fast your machine pays for itself.*

**Core values**
1. **The honest cost per cup.** Beans, milk, syrup — even machine depreciation — folded into one real number, not a guess.
2. **Break‑even, visualised.** See exactly how many cups (and months) until that espresso machine beats buying out, with a cumulative‑savings chart.
...
>
> **Free** to calculate and build your library. **Personal Pro** (one‑time) unlocks the ROI charts, spending tracker, unlimited recipes, and export.

**Keywords / tags**
`coffee cost calculator, home barista, espresso ROI, break even calculator, coffee budget, cost per cup, specialty coffee, pour over, brew ratio, coffee tracker, latte cost, equipment payback`

## 한국어

**태그라인:** *내 커피 습관의 진짜 비용 — 그리고 머신이 언제 본전을 뽑는지.*

**핵심 가치**
1. **솔직한 잔당 원가.** 원두·우유·시럽에 장비 감가까지 더한 진짜 한 잔 값. 어림짐작이 아니라 숫자로.
2. **눈으로 보는 손익분기.** 그 에스프레소 머신이 사 마시기 대비 몇 잔·몇 개월에 본전인지, 누적 절감 차트로 한눈에.
...
>
> **무료**로 계산하고 라이브러리를 만드세요. **Personal Pro**(일회성 결제)는 본전 차트·지출 트래커·무제한 레시피·내보내기를 잠금 해제합니다.

**키워드 / 태그**
`커피 원가 계산기, 홈카페, 에스프레소 본전, 손익분기, 커피 가계부, 잔당 원가, 스페셜티 커피, 푸어오버, 추출 비율, 커피 지출, 라떼 원가, 장비 본전`
...
**Tagline:** *Price every drink with confidence — know the cost, the margin, and the leak.*

**Core values**
1. **True cost per drink.** Ingredients with waste, packaging, labour and overhead — your *full* COGS, not just beans and milk.
2. **Pricing that protects margin.** Set a target margin → get a charm‑rounded price. Or enter your price → see the real margin and food‑cost %. Thin margins are flagged automatically.
...
>
> No account, no monthly SaaS fee — your data stays on your device. **Café Pro** is a one‑time (or subscription) unlock for the full toolkit.

**Keywords / tags**
`cafe COGS calculator, coffee shop pricing, menu margin, food cost percent, recipe costing, drink pricing tool, barista business, menu engineering, profit margin calculator, coffee shop management, what-if pricing, hospitality costing`

## 한국어

**태그라인:** *모든 음료를 자신 있게 가격 책정 — 원가, 마진, 그리고 새는 곳까지.*

**핵심 가치**
1. **음료별 진짜 원가.** 폐기율·포장·인건비·간접비까지 더한 *완전* 원가. 원두·우유만이 아닙니다.
2. **마진을 지키는 가격책정.** 목표 마진 입력 → 심리가 반올림된 추천가. 또는 판매가 입력 → 실제 마진과 원가율 확인. 저마진은 자동 경고.
...
>
> 계정 없음, 월 구독 없음 — 데이터는 내 기기에. **Café Pro**는 전체 기능을 여는 일회성(또는 구독) 결제입니다.

**키워드 / 태그**
`카페 원가 계산기, 커피숍 가격책정, 메뉴 마진, 원가율, 레시피 원가, 음료 가격 도구, 카페 창업, 메뉴 엔지니어링, 마진 계산기, 카페 운영, 가격 시뮬레이션, 음료 COGS`
